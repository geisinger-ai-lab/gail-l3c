...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.4fb2aafa-e58f-4d41-8f98-6121a03de36e"),
    concept_set_members=Input(rid="ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6")
)
select *
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.c317ad71-18c6-4651-a997-b377fbcc5e0d"),
    drug_exposure_merge=Input(rid="ri.foundry.main.dataset.d78c602f-06a3-410e-9092-fbd66f0091bb"),
    index_range=Input(rid="ri.foundry.main.dataset.37168eef-4434-4de4-9fca-2d1ab449e3b2"),
    meds_concepts=Input(rid="ri.foundry.main.dataset.4fb2aafa-e58f-4d41-8f98-6121a03de36e")
)
select
    d.person_id
    , d.drug_concept_id
...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.a9c6a2e1-4269-4b30-b475-4160cf9007af"),
    meds_filtered=Input(rid="ri.foundry.main.dataset.c317ad71-18c6-4651-a997-b377fbcc5e0d")
)
select 
    m.person_id
